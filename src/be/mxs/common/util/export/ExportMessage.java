...
public class ExportMessage {
	...
	private Element addPatients(){
		...
		Element patients = DocumentHelper.createElement("patients");
				//Hier maken we een lijst van alle patiΈnten waarvan gegevens geΈxporteerd moeten kunnen worden
		...
		try{
			...
			//Nu hebben we alle patiΈnten waarvoor wijzigingen werden aangebracht in de database, we gaan deze exporteren
