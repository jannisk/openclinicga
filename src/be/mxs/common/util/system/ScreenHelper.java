...
public class ScreenHelper {
    ...
    public static SimpleDateFormat euDateFormat = new SimpleDateFormat("dd/MM/yyyy"); //new SimpleDateFormat(MedwanQuery.getInstance().getConfigString("euDateFormat","dd/MM/yyyy")); // used when storing dates in DB
    ...
    public static void reloadDateFormats(){
        hourFormat       = new SimpleDateFormat("HH:mm"); //new SimpleDateFormat(MedwanQuery.getInstance().getConfigString("hourFormat","HH:mm"));
        stdDateFormat    = new SimpleDateFormat("dd/MM/yyyy"); //SimpleDateFormat(MedwanQuery.getInstance().getConfigString("dateFormat","dd/MM/yyyy"));
