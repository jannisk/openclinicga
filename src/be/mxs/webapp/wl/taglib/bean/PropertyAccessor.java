            ...
            if (o instanceof Collection) {
                ...
                while (iterator.hasNext() && (!found)) {
                    ...
                    try {
                        ...
                        if (_method.getReturnType().isAssignableFrom(java.lang.String.class)) {
                            ...
                            objectValue = (java.lang.Integer)_method.invoke(_o, (Object[]) null);
                            ...
                            objectValue = (_method.invoke(o, (Object[]) null)).toString();
                            pageContext.getOut().print((String)objectValue);
                            ////Debug.println("objectValue = " + objectValue);
                ...
                if (isComparable(o)) {
                    ...
                    try {
                        ...
                        Method _method = o.getClass().getMethod(getterName, (Class<?>[]) null);

                        if (_method.getReturnType().isAssignableFrom(java.lang.String.class)) {

                            ////Debug.println("_method.getReturnType() = String");
                            objectValue = (String)_method.invoke(o, (Object[]) null);
                            pageContext.getOut().print((String)objectValue);
                            ////Debug.println("objectValue = " + objectValue);
                            ...
                            ////Debug.println("_method.getReturnType() = Date");
                            java.util.Date date = (java.util.Date) _method.invoke(o, (Object[]) null);
                            int _timeField = -1;
